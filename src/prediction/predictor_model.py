...
class Forecaster:
    """A wrapper class for the NLinear Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "NLinear Forecaster"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            normalize (bool):
                Whether to apply the simple “normalization” proposed in the paper,
                which consists in subtracting the last value of the input sequence from the input sequence. Default: False.
    ...
    def fit(
        ...
        A separate NLinear model is fit to each series that is contained
        in the data.
    ...
    def load(cls, model_dir_path: str) -> "Forecaster":
        ...
        model = NLinearModel.load(os.path.join(model_dir_path, MODEL_FILE_NAME))
